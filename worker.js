...
async function handleRequest(request) {
    try { // Check if the request method is POST
        if (request.method === "POST") {
            ...
            await submitToGoogleForm(entry1, entry2, entry3, entry4, entry5, entry6, entry7, entry8, entry9, entry10, entry11, entry12, entry13, entry14, entry15, entry16);
...
async function submitToGoogleForm(entry1, entry2, entry3, entry4, entry5, entry6, entry7, entry8, entry9, entry10, entry11, entry12, entry13, entry14, entry15, entry16) {
    const formUrl = "https://docs.google.com/forms/u/0/d/e/1FAIpQLSfxIRlBfpbJ6QS0JLh2bdy7-PZ1Fe5WlANecsHFOF6_RDUWvQ/formResponse    `";
    ...
    urlencoded.append("entry.1182897846", entry5);
    urlencoded.append("entry.316715673", entry6);
    urlencoded.append("entry.1193926513", entry7);
    urlencoded.append("entry.875091108", entry8);
    urlencoded.append("entry.31134898", entry9);
    urlencoded.append("entry.463664041", entry10);
    urlencoded.append("entry.1672731479", entry11);
    urlencoded.append("entry.335192038", entry12);
    urlencoded.append("entry.934455295", entry13);
    urlencoded.append("entry.621779747", entry14);
