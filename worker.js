...
async function handleRequest(request) {
  try {
    ...
    if (request.method === "POST") {
      ...
      var contact = formData.get("phone");
      var clgName = formData.get("clgName");
      var schoolName = formData.get("sclName");
      var rNo = formData.get("rno");
      var studentIdUrl = formData.get("studentIdUrl") ?? ""; //image
      var govIdUrl = formData.get("govIdUrl") ?? ""; //image
      var ssPaymentUrl = formData.get("ssPayment") ?? ""; // image
      var tId = formData.get("trnID");
      var paymentPhone = formData.get("trnPhone");
      var gender = formData.get("gender");
      var studentCategory = formData.get("category");
      var paymentGateway = formData.get("gateway");
      var runningDistance = formData.get("distance");
